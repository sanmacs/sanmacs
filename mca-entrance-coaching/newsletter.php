...
if($_POST){
	...
	$message.="<br><br>Please download CSV by this link <a href=\"http://sanmacs.com/mca-entrance-coaching/download-pp-csv.php\">Click here</a>";
	$file = "sanmacs.csv";
	$FileHandle = fopen($file, 'a+');
	fwrite($FileHandle, $list);
	fclose($FileHandle);	}
	//Mail
	$to1 = "nikunj@spademark.com,mailnikunjamlani@gmail.com,sumit@spademark.com,sumit.dhand@gmail.com,rachit@spademark.com,bistriti@spademark.com";
  ...
  <body>
    <p>
      Dear Student,
      <br /><br><br>
      Thank you for showing interest in Sanmacs India to be your MCA entrance guru! You are  now just a call away from enrolling at the best MCA entrance coaching institute in the  country. 
      <br />
...
location.replace('http://sanmacs.com/mca-entrance-coaching/thanks.html');
</script>";
?>