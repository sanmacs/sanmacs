...
if($_POST){
    ...
    $message.="<br><br>Please download CSV by this link <a href=\"http://sanmacs.com/online-mca-entrance/download-pp-csv.php\">Click here</a>";
	$file = "sanmacs.csv";
  ...
  <body>
    ...
    If the above information is incorrect, then kindly fill up the form again: 
      <a href='http://sanmacs.com/online-mca-entrance/'>
        click here
      </a>
      <br />
      <br />
...
location.replace('http://sanmacs.com/online-mca-entrance/thanks.html');
</script>";
?>