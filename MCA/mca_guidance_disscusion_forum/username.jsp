...
DIV.Object9 { position:absolute; top:360px; left:0px; z-index:3;}
</style>
<script>
...
<tr><th>
<table border=1 cellpadding=3 cellspacing=0 width=280 bordercolor=white bgcolor=#E4EAF2 align=center>
<%!Connection con;
...
%>
<tr height=20><td colspan=2 background="http://www.sanmacs.com/images2/discussion_forum/bg_image.gif"><p id="ftpw" align=center><b><%=rs.getString("fname") %> <%=rs.getString("lname") %></b></p></td></tr>
...
<tr><th height=7></th></tr>
<tr><th>
<iframe name=msg width=280 height=150 frameborder=0 scrolling=no src="http://www.sanmacs.com/mca_guidance_disscusion_forum/blank.htm"></iframe>
</th></tr>
...
<%
	...
	profilecounter++;
%>
<tr><th><p id="ftp" align=left style="color:blue"><a class="ds" href="http://www.sanmacs.com/mca_guidance_disscusion_forum/message.jsp?check=<%=conid %>&mail=<%=mail_id %>" target="msg"><%=fullname %></a></p></th></tr>
<%
	}
	profilecounter=0;
	}
...
<%
	...
	profilecounter++;
%>
<tr><th><p id="ftp" align=left style="color:blue"><a class="ds" href="http://www.sanmacs.com/mca_guidance_disscusion_forum/message.jsp?check=<%=conid %>&mail=<%=mail_id1 %>" target="msg"><%=fullname1 %></a></p></th></tr>
<%
	}
	profilecounter=0;
	}
