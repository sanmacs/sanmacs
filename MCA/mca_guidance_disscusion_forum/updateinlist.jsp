...
<Div class="Object7">
<form name=ft method="Post" action="http://www.sanmacs.com/mca_guidance_disscusion_forum/outlist.jsp">
...
<%
	...
	for(int i=0; i<counter; i++) {
	if (msg[i]!=0) {
	st2.executeUpdate("Update message set category='INBOX' where msid="+msg[i]+"");
%>
<tr><th><p id="ftp" style="font-size:14px" align="justify">Message No. <%=i+1 %> moved to inbox.</p></th></tr>
<%
	}
	}
%>
