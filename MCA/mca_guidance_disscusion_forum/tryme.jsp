...
<%
	...
	rs=st.executeQuery("Select Thread_id,User_id,Heading,Latest_replyid,Views from Thread where Forum='"+forum_type+"'");
%>
<Div class="Object7">
...
<tr><td width=177 height=<%=(4+(counter*30)) %> bgcolor=#933900></td></tr>
</table>
</Div>

<DIV class="Object9" style="top:<%=(468+(counter*30)) %>px;">
...
<DIV class="Object10" style="top:<%=(498+(counter*30)) %>px;">
