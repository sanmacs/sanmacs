...
<%
	...
	get_register=request.getParameter("cregister");
	if (get_register==null) {
	get_register1="No";
	}
	else {
	get_register1=get_register;
	}
...
<%
	...
	if (rs.next()==false) {
	st.executeUpdate("Insert into Alumni(Email, Birth_day, Birth_month, Birth_year, alumnimeet) values('"+Email+"',"+Birth_day+",'"+Birth_month+"',"+Birth_year+",'"+get_register1+"')");
%>
	<tr><th><p id="ftp">Thank you for registering for alumni meet in December 2006.</p></th></tr>
	<tr><td height=20></td></tr>
	<tr><th><a href="http://www.sanmacs.com/sanmacs_mca_entrance_alumni/reg.jsp"><img src="http://www.sanmacs.com/images2/alumni/add_profile.gif" name=bck2 onMouseover="bck2.src='http://www.sanmacs.com/images2/alumni/add_profile1.gif'" onMouseout="bck2.src='http://www.sanmacs.com/images2/alumni/add_profile.gif'" border=0></img></a></th></tr>
<%
	...
	st.executeUpdate("Update Alumni set alumnimeet='"+get_register1+"' where Email='"+Email+"' and Birth_day="+Birth_day+" and Birth_month='"+Birth_month+"' and Birth_year="+Birth_year+"");

	session.setAttribute("emid",Email);
%>
	<tr><th><p id="ftp">Thank you for registering for alumni meet in December 2006.</p></th></tr>
	<tr><td height=10></td></tr>
	<tr><td><p id="ftp" align="justify">You are already registered as <b>Sanmacs Alumni</b>. <b>Edit Your Profile</b> by clicking the link below or click <b>Exit</b> to exit the page.</p></td></tr>
	<tr><td height=20></td></tr>
	<tr><th>
	<a href="http://www.sanmacs.com/sanmacs_mca_entrance_alumni/edit_profile.jsp"><img src="http://www.sanmacs.com/images2/alumni/edit_profile.gif" name=bck onMouseover="bck.src='http://www.sanmacs.com/images2/alumni/edit_profile1.gif'" onMouseout="bck.src='http://www.sanmacs.com/images2/alumni/edit_profile.gif'" border=0></img></a>
	<a href="http://www.sanmacs.com/"><img src="http://www.sanmacs.com/images2/alumni/exit.gif" name=bck3 onMouseover="bck3.src='http://www.sanmacs.com/images2/alumni/exit1.gif'" onMouseout="bck3.src='http://www.sanmacs.com/images2/alumni/exit.gif'" border=0></img></a>
	</th></tr>
<%
	}
	else {
	...
	session.setAttribute("getid",get_register1);
%>
	...
	<a href="http://www.sanmacs.com/sanmacs_mca_entrance_alumni/alumni_meet.htm"><img src="http://www.sanmacs.com/images2/alumni/incorrect.gif" name=bckx onMouseover="bckx.src='http://www.sanmacs.com/images2/alumni/incorrect1.gif'" onMouseout="bckx.src='http://www.sanmacs.com/images2/alumni/incorrect.gif'" border=0></img></a>
	</th>
	</tr>
<%
	}
