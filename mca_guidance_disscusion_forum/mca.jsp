...
<tr><td width=177 height=<%=(4+(counter*33)) %> bgcolor=#933900></td></tr>
</table>
</Div>

<DIV class="Object9" style="top:<%=(468+(counter*33)) %>px;">
...
<DIV class="Object10" style="top:<%=(498+(counter*33)) %>px;">
