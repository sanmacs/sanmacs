...
DIV.Object4 { position:absolute; top:110px; left:0px; z-index:3; }
...
DIV.Object10 { position:absolute; top:668px; left:0px; width:780px; z-index:9;}
...
<%
	...
	quote_id=request.getParameter("check");
	...
	rsm.putValue("quoteid",quote_id);
	rsm.putValue("replyid",reply_id);
	rsm.putValue("curr",current);
...
<tr><th>
<table border=0 cellpadding=4 cellspacing=2 width=86%>
<tr><th width=30%><p id="ftp" align="justify">Heading</p></th><td></td></tr>
<tr><th valign=top><p id="ftp" align="justify">Comments</p></th><td><%@ include file="rqoutbar.jsp" %></td></tr>
</table>
</th></tr>
</table>
</Div>
