...
<form name="Compose" id="Compose" method=post action="http://www.sanmacs.com/mca_guidance_disscusion_forum/addthread.jsp">
...
<p id="ftp" align="justify" style="margin-left:17px"><textarea cols=48 rows=13 name=PlainMsg></textarea></p>
</Div>

<Div style="position:absolute; top:300px; left:250px">
<input type="button" name="sendtop" id="sendtop" value="Add Thread" title="Thread" onclick="check();">
</Div>
