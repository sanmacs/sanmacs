...
function testForm1() {
	...
	if (FirstName()  && Mailadd() && Mobile() && Email() && colAndCourse() && Passing_Year() ){
...
function Batch_Preferences()
{
	...
	var preferred_month=document.getElementById("preferred_month");
	var preferred_batch=document.getElementById("preferred_batch");
    if(preferred_Study_Centre.value =="")
			 ...
			 else if(preferred_month.value =="")
			 {
        	 alert ("Select your preferred month ");
			 preferred_month.focus();
        	 return false;
        	 }
			 else if(preferred_batch.value =="")
			 {
        	 alert ("Select your preferred batch ");
			 preferred_batch.focus();
        	 return false;
        	 }
             else
